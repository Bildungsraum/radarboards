...
const fontSizeLabelDimKreis = 16;
...
const colorLabelCircleSeries3 = am5.Color.lighten(am5.color(0xffffff), -0.52);
const colorLabelCircleSeries2 = am5.Color.lighten(am5.color(0xffffff), -0.6);
const colorLabelCircleSeries1 = am5.Color.lighten(am5.color(0xffffff), -0.8);
...
const fontSizeLabelAussen = 16.5;
const fontSizeLabelKreis = 10.5;

const fontWeightLabelAussen = "normal";

const fontWeightUDimLabelAussen = 700;
const anzahlLegendGridUDim = 4;
const anzahlUDim = 3;
var fontSizeLegende = 11; if (window.innerHeight < 700) { fontSizeLegende = 10 };
var fontSizeLegendeEinzelUDim = 11;
var fontSizeLabelProjekteEinzelUDim = 12;
var radiusLabelProjekteEinzelUDim = 10; //abstand label Projektnamen in Ansicht einzel UDim für alle Projekte
...
// MBR Fraben
const ColorDim1Value3 = am5.Color.lighten(am5.color(0x7dba88), 0.0); // Dimension1 in Invite=Interoperabilität, Farbe grün, value 1 ausgeprägt
const ColorDim1Value2 = am5.Color.lighten(am5.color(0xa8d1af), 0.0); // values 2 vorhanden, ///wird nicht benutzt, da opacity verändert wird
const ColorDim1Value1 = am5.Color.lighten(am5.color(0xd4e8d7), 0.0); // values 3 ohne loch, bewertung 0-1 innen kreis
const ColorDim1Value4 = am5.Color.lighten(am5.color(0x268c38), 0.0); // Farbe Ring Gesamtvalues

const ColorDim2Value3 = am5.Color.lighten(am5.color(0x9e8bb4), 0.0); // Serie2 in Invite=Algorithmen, Farbe türkis
const ColorDim2Value2 = am5.Color.lighten(am5.color(0xbeb2cd), 0.0);
const ColorDim2Value1 = am5.Color.lighten(am5.color(0xdfd8e6), 0.0);
const ColorDim2Value4 = am5.Color.lighten(am5.color(0x5d3e82), 0.0); // Farbe Ring Gesamtvalues


const ColorDim3Value3 = am5.Color.lighten(am5.color(0xf9c275), 0.0); // Serie3 in Invite=Nutzerorientierung, Farbe lila
const ColorDim3Value2 = am5.Color.lighten(am5.color(0xfbd6a3), 0.0);
const ColorDim3Value1 = am5.Color.lighten(am5.color(0xfdebd1), 0.0);
const ColorDim3Value4 = am5.Color.lighten(am5.color(0xf49919), 0.0); // Farbe Ring Gesamtvalues

const ColorDim4Value3 = am5.Color.lighten(am5.color(0x66add3), 0.0); // Serie4 in Invite=Nachnutzbarkeit, Farbe blau
const ColorDim4Value2 = am5.Color.lighten(am5.color(0x99c9e2), 0.0);
const ColorDim4Value1 = am5.Color.lighten(am5.color(0xcce4f0), 0.0);
const ColorDim4Value4 = am5.Color.lighten(am5.color(0x0077b6), 0.0); // Farbe Ring Gesamtvalues

const ColorDim5Value3 = am5.Color.lighten(am5.color(0xe19688), 0.0); // Serie5 in Invite=Informationssicherheit, Farbe rot
const ColorDim5Value2 = am5.Color.lighten(am5.color(0xebb9af), 0.0);
const ColorDim5Value1 = am5.Color.lighten(am5.color(0xf5dcd7), 0.0);
const ColorDim5Value4 = am5.Color.lighten(am5.color(0xcd5038), 0.0); // Farbe Ring Gesamtvalues

const ColorDim6Value3 = am5.Color.lighten(am5.color(0x588584), 0.20); // Serie6 in Invite=Informationssicherheit, Farbe hrll türkis, 588584
const ColorDim6Value2 = am5.Color.lighten(am5.color(0xAAB7B7), 0.0);
const ColorDim6Value1 = am5.Color.lighten(am5.color(0xCEDDDD), 0.25);
const ColorDim6Value4 = am5.Color.lighten(am5.color(0xCEDDDD), 0.25); // Farbe Ring Gesamtvalues
...
//MBR 
var series1TechDimColors = [ColorDim1Value3, ColorDim2Value3, ColorDim3Value3, ColorDim4Value3, ColorDim5Value3, ColorDim6Value3];
var series2TechDimColors = [ColorDim1Value2, ColorDim2Value2, ColorDim3Value2, ColorDim4Value2, ColorDim5Value2, ColorDim6Value2];
var series3TechDimColors = [ColorDim1Value1, ColorDim2Value1, ColorDim3Value1, ColorDim4Value1, ColorDim5Value1, ColorDim6Value1];

if (thema == "Fachlich") {
  series1TechUDimColors = [ColorDim1Value3, ColorDim1Value3, ColorDim1Value3, ColorDim2Value3, ColorDim2Value3, ColorDim2Value3, ColorDim3Value3, ColorDim3Value3, ColorDim3Value3, ColorDim4Value3, ColorDim4Value3, ColorDim4Value3, ColorDim5Value3, ColorDim5Value3, ColorDim5Value3, ColorDim6Value3, ColorDim6Value3, ColorDim6Value3];
  series2TechUDimColors = [ColorDim1Value2, ColorDim1Value2, ColorDim1Value2, ColorDim2Value2, ColorDim2Value2, ColorDim2Value2, ColorDim3Value2, ColorDim3Value2, ColorDim3Value2, ColorDim4Value2, ColorDim4Value2, ColorDim4Value2, ColorDim5Value2, ColorDim5Value2, ColorDim5Value2, ColorDim6Value2, ColorDim6Value2, ColorDim6Value2];
  series3TechUDimColors = [ColorDim1Value1, ColorDim1Value1, ColorDim1Value1, ColorDim2Value1, ColorDim2Value1, ColorDim2Value1, ColorDim3Value1, ColorDim3Value1, ColorDim3Value1, ColorDim4Value1, ColorDim4Value1, ColorDim4Value1, ColorDim5Value1, ColorDim5Value1, ColorDim5Value1, ColorDim6Value1, ColorDim6Value1, ColorDim6Value1];
}
...
const colorKoordinatoren_36 = am5.Color.lighten(am5.color(0xD92120), 0.4);
const colorKoordinatoren_37 = am5.Color.lighten(am5.color(0xD92120), 0.4);
const colorKoordinatoren_38 = am5.Color.lighten(am5.color(0xD92120), 0.4);
const colorKoordinatoren_39 = am5.Color.lighten(am5.color(0xD92120), 0.4);
const colorKoordinatoren_40 = am5.Color.lighten(am5.color(0xD92120), 0.4);
const colorKoordinatoren_41 = am5.Color.lighten(am5.color(0xD92120), 0.4);
const colorKoordinatoren_42 = am5.Color.lighten(am5.color(0xD92120), 0.4);
const colorKoordinatoren_43 = am5.Color.lighten(am5.color(0xD92120), 0.4);
const colorKoordinatoren_44 = am5.Color.lighten(am5.color(0xD92120), 0.4);
...
var colorSetKoordinatoren = [
  ...
  colorKoordinatoren_36,
  colorKoordinatoren_37,
  colorKoordinatoren_38,
  colorKoordinatoren_39,
  colorKoordinatoren_40,
  colorKoordinatoren_41,
  colorKoordinatoren_42,
  colorKoordinatoren_43,
  colorKoordinatoren_44,
